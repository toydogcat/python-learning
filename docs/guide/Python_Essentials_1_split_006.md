...
1. empty\_tuple = ()
2. print(type(empty\_tuple)) # outputs: <class ‘tuple’=””></class>
...
1. my\_tuple\_1 = 1,
2. print(type(my\_tuple\_1)) # outputs: <class ‘tuple’=””></class>
4. my\_tuple\_2 = 1 # This is not a tuple.
5. print(type(my\_tuple\_2)) # outputs: <class ‘int’=””></class>
...
6. print(type(my\_list)) # outputs: <class ‘list’=””></class>
...
1. tup = 1, 2, 3,
2. my\_list = list(tup)
3. print(type(my\_list)) # outputs: <class ‘list’=””></class>
...
File “code.py”, line 1, in <module></module>
